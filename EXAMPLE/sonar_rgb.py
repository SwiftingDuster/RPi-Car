...
def colorWipe(color, wait_ms=50):
    ...
    for i in range(sonar.numPixels()):
        sonar.setPixelColor(i, color)
        sonar.show()
...
def theaterChase(color, wait_ms=50, iterations=10):
    ...
    for j in range(iterations):
        for q in range(3):
            for i in range(0, sonar.numPixels(), 3):
                sonar.setPixelColor(i + q, color)
            sonar.show()
            time.sleep(wait_ms / 1000.0)
            for i in range(0, sonar.numPixels(), 3):
                sonar.setPixelColor(i + q, 0)
...
def rainbow(wait_ms=20, iterations=1):
    ...
    for j in range(256 * iterations):
        for i in range(sonar.numPixels()):
            sonar.setPixelColor(i, wheel((i + j) & 255))
        sonar.show()
        time.sleep(wait_ms / 1000.0)
...
def rainbowCycle(wait_ms=20, iterations=5):
    ...
    for j in range(256 * iterations):
        for i in range(sonar.numPixels()):
            sonar.setPixelColor(i, wheel(
                (int(i * 256 / sonar.numPixels()) + j) & 255))
        sonar.show()
        time.sleep(wait_ms / 1000.0)
...
def theaterChaseRainbow(wait_ms=50):
    ...
    for j in range(256):
        for q in range(3):
            for i in range(0, sonar.numPixels(), 3):
                sonar.setPixelColor(i + q, wheel((i + j) % 255))
            sonar.show()
            time.sleep(wait_ms / 1000.0)
            for i in range(0, sonar.numPixels(), 3):
                sonar.setPixelColor(i + q, 0)
